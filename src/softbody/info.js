...
export class Info {
    constructor() {
        ...
        info.addBlade({
            view: "infodump",
            content: "Realtime Tetrahedral FEM Models in the Browser, using WebGPU and written in [ThreeJS](https://threejs.org) TSL. Based on the WebGL implementation in [TetSim](https://github.com/zalo/TetSim) by [Johnathon Selstad](https://github.com/zalo).\n\n" +
                ...
                "[Rock texture](https://www.texturecan.com/details/240/) by [texturecan.com](https://texturecan.com).\n\n" +
